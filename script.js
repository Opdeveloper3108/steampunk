window.addEventListener('load', function () {
    ...
    class particle {
        ...
        update() {
            ...
            this.y += this.speedY;
            if (this.y > this.game.height + this.size || HTMLDListElement.x < 0 - this.size) this.markedforDeletion = true;
    ...
    class Player {
        constructor(game) {
            ...
            this.frameY = 0;
            this.maxFrame = 37;
            this.speedY = 0; //no movement
            this.maxSpeed = 5; //max speed change player
            this.projectiles = [];
    ...
    class UI {
        ...
        draw(context) {
            ...
            context.fillText('Timer: ' + formattedTime, 20, 170);
            //game over Messages
            if (this.game.gameOver) {
                ...
                if (this.game.score > this.game.winningScore) {
                    message1 = 'You Survived!';
                    message2 = 'Well Done Survivor!';
                }
                else {
                    message1 = 'You were Destroyed!';
                    message2 = 'Repair and Try Again!';
                }
                context.font = '100px  ' + this.fontfamily;
                context.fillText(message1, this.game.width * 0.5, this.game.height * 0.5);
                context.font = '50px  ' + this.fontfamily;
                context.fillText(message2, this.game.width * 0.5, this.game.height * 0.65);
            ...
            for (let i = 0; i < this.game.ammo; i++) {
                context.fillRect(20 + 5 * i, 90, 3, 20);
            }
